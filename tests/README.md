...
| File | Description |
|------|-------------|
| `test_code_diagrams_generator.py` | Code-flow generator internals: target resolution/output paths, deterministic timestamps, idempotent whole-tree source-marker reconciliation, orphan pruning, formatter failure propagation, and bounded Playwright screenshot scaling. |
